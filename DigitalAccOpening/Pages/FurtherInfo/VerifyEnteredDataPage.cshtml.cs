...
{
    public class VerifyEnteredDataPageModel : PageModel
    {
        private readonly DB.ApplicationDbContext _dbContext;
        public VerifyEnteredDataPageModel(DB.ApplicationDbContext dbContext)
        {
        ...
        public async Task<IActionResult> OnPostUpdatePersonalInfoAsync()
        {
            ...
            {
                // Update the fields
                customerPersonalInfo.CustomerName = n;
                customerPersonalInfo.CustomerFatherName = fn;
                customerPersonalInfo.CustomerDOB = d.ToString();
                customerPersonalInfo.CustomerPlaceOfBirth = cob;
                customerPersonalInfo.CustomerCnicIssuenceDate = ci.ToString();
                customerPersonalInfo.CustomerCnicExpiryDate = ce.ToString();
        ...
        {
            return RedirectToPage("LastPage");
        }
